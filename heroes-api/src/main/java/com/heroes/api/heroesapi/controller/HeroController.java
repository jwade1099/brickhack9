...
import com.heroes.api.heroesapi.persistence.HeroFileDAO;
...
public class HeroController {
    ...
    public ResponseEntity<Hero[]> getHeroes() {
        ...
        try {
            return new ResponseEntity<Hero[]>(heroDao.getHeroes(),HttpStatus.OK);
        } catch (IOException e) {
            LOG.log(Level.SEVERE,e.getLocalizedMessage());
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<Hero> createHero(@RequestBody Hero hero) {
        ...
        try {
            if (heroDao.createHero(hero) != null) {
                return new ResponseEntity<Hero>(hero,HttpStatus.CREATED);
            } 
            else {
                return new ResponseEntity<Hero>(hero,HttpStatus.CONFLICT);
            }
        } catch (IOException e){
            LOG.log(Level.SEVERE,e.getLocalizedMessage());
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<Hero> updateHero(@RequestBody Hero hero) {
        ...
        try {
            if (heroDao.updateHero(hero) != null) {
    ...
    public ResponseEntity<Hero> deleteHero(@PathVariable int id) {
        ...
        try {
            if (heroDao.deleteHero(id) == false){
                return new ResponseEntity<Hero>(HttpStatus.NOT_FOUND);
            }
            else {
